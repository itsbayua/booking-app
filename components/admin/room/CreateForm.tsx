      ...
      <div className="grid md:grid-cols-12 gap-5">
        ...
        <div className="col-span-4 bg-white p-4">
            ...
            <div className="flex flex-col items-center justify-center text-gray-500 pt-5 pb-6 z-10">
              ...
              {image ? (
                <button
                  ...
                  className="flex items-center justify-center bg-transparent size-6 top-1 text-white hover:bg-red-400 rounded-sm absolute right-1"
                >
          ...
          <div className="mb-4">
            ...
            {/* General Message */}
            {state?.message ? (
              <div className="my-4 bg-red-200 p-2">
            ...
            <button
              type="submit"
              className={clsx(
                "bg-orange-400 mt-4 text-white w-full hover:bg-orange-500 py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer",
                {
